-- Olympics PWA Database Schema - FINAL WORKING VERSION
...
-- 8. Gameboard Stations table - FIXED with all required columns
...
-- Insert gameboard stations with matching column names
