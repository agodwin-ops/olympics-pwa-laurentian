-- Olympics PWA Database Schema - API Compatible Version
-- Matches the data types expected by the API code
...
-- 4. Player Stats table with all expected columns
...
-- 8. Gameboard Stations table (using INTEGER id to match API)
...
-- 12. Gameboard Moves Log table (using INTEGER for station_id to match)
...
-- Insert gameboard stations with specific IDs to match API expectations
INSERT INTO gameboard_stations (id, name, description, skill_required, min_level, xp_reward, gold_reward, energy_cost, station_type, order_index) VALUES
    (1, 'Training Camp', 'Build your fundamental skills', 'strength', 1, 10, 5, 10, 'skill', 1),
    (2, 'Endurance Challenge', 'Test your stamina and persistence', 'endurance', 1, 15, 8, 15, 'challenge', 2),
    (3, 'Strategy Room', 'Plan your Olympic approach', 'tactics', 1, 20, 10, 12, 'skill', 3),
    (4, 'Cooking Academy', 'Master culinary arts', 'cooking', 2, 25, 12, 18, 'skill', 4),
    (5, 'Leadership Summit', 'Develop team leadership skills', 'leadership', 2, 30, 15, 20, 'skill', 5),
    (6, 'Negotiation Table', 'Practice diplomatic solutions', 'negotiation', 3, 35, 18, 22, 'skill', 6),
    (7, 'Athletic Arena', 'Push your physical limits', 'athletics', 3, 40, 20, 25, 'challenge', 7),
    (8, 'Knowledge Library', 'Expand your understanding', 'knowledge', 2, 28, 14, 16, 'skill', 8),
    (9, 'Creative Workshop', 'Unleash innovative thinking', 'creativity', 3, 45, 25, 24, 'skill', 9),
    (10, 'Problem Solving Lab', 'Tackle complex challenges', 'problem_solving', 4, 50, 30, 28, 'challenge', 10),
    (11, 'Boss Battle Arena', 'Face the ultimate challenge', 'tactics', 5, 100, 75, 50, 'boss', 11),
    (12, 'Treasure Vault', 'Discover special rewards', 'luck', 1, 15, 50, 5, 'special', 12)
ON CONFLICT (id) DO NOTHING;

-- Reset sequence for gameboard_stations to continue from 13
