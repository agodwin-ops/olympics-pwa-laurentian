-- Olympics PWA Database Schema - Fixed Version
...
CREATE POLICY IF NOT EXISTS "Service role access users" ON users FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access units" ON units FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access assignments" ON assignments FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access player_stats" ON player_stats FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access xp_entries" ON xp_entries FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access lectures" ON lectures FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access lecture_resources" ON lecture_resources FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access gameboard_stations" ON gameboard_stations FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access player_skills" ON player_skills FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access player_inventory" ON player_inventory FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access quest_progress" ON quest_progress FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access gameboard_moves_log" ON gameboard_moves_log FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access skill_increases_log" ON skill_increases_log FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Service role access battleboard_encounters" ON battleboard_encounters FOR ALL USING (true);
